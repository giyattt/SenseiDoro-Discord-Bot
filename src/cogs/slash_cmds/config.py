async def config(self, ctx):
    ...
    if ctx.guild.id not in self.bot.dojos:
        await ctx.respond("Server not initialized properly. Please wait a moment and try again.")
        return
        
    await ctx.respond(embed=self.config_embed,
